...
# step 28 : mongodb geospatial query api with params

1. from the bootcamp routes, add a new route for get bootcamps within a radius
2. copy the delete route and modify it to get bootcamps within a radius
...
4. create new a api request in the postman and test the API
5.
